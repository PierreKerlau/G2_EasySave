...
namespace EasySave.Cryptography
{
    public static class CryptoManager
    {
        ...
        static CryptoManager()
        {
            ...
            _key = Environment.GetEnvironmentVariable("EASYSAVE_CRYPTO_KEY");
            if (string.IsNullOrEmpty(_key))
            {
                throw new Exception("La clé de cryptage n'est pas définie dans les variables d'environnement");
            }
        }
